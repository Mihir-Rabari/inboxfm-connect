...
description: "Use your own OAuth2 credentials instead of the default Inboxfm Connect apps"
icon: "lock"
---
...
When users connect to services like Google Sheets or Slack, they see "Inboxfm Connect" as the app requesting access. This works out of the box with no setup required.

## Why Replace OAuth2 Apps?

- **Branding**: Show your company name instead of "Inboxfm Connect" in authorization screens
