...
description: "Documentation on project permissions in Inboxfm Connect"
icon: 'user'
---

<Snippet file="enterprise-feature.mdx" />

Inboxfm Connect utilizes Role-Based Access Control (RBAC) for managing permissions within projects. Each project consists of multiple flows and users, with each user assigned specific roles that define their actions within the project.

## Default Roles

Inboxfm Connect comes with four standard roles out of the box. The table below shows the permissions for each role:
