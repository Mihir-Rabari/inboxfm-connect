...
description: "Connect HashiCorp Vault to Inboxfm Connect for enterprise-grade secret management"
---
...
Before connecting HashiCorp Vault to Inboxfm Connect, ensure you have:
...
Once the connection is saved, you can reference Vault secrets inside any piece connection dialog — in global connections (Platform Admin) or directly when configuring a trigger or action.
