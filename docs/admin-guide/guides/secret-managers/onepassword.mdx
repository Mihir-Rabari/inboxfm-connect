---
title: "1Password"
description: "Connect 1Password to Inboxfm Connect for centralized secret management"
---
...
3. Give it a name (e.g. `Inboxfm Connect`).
4. Grant it **Read Items** access on the vaults Inboxfm Connect needs to access.
...
## Step 2 — Connect in Inboxfm Connect
...
Inboxfm Connect will retrieve the secret value from 1Password and inject it into the connection at runtime.
