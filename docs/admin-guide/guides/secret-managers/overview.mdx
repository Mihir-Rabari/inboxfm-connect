...
Secret Managers allow you to integrate external secret management systems with Inboxfm Connect, enabling centralized credential management and enhanced security for your global connections.
...
1. Open a connection dialog (either a global connection or one inside a trigger/action configuration)
...
- When the flow runs, Inboxfm Connect authenticates with your secret manager and retrieves the secret
- Secrets are fetched on-demand and never stored in Inboxfm Connect
...
- **Network Security**: Ensure your secret manager is accessible from your Inboxfm Connect instance
...
- Ensure network connectivity between Inboxfm Connect and your secret manager
