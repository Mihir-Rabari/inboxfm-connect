...
To make the trigger readable by Inboxfm Connect, add it to the array of triggers in the piece definition.
...
To test the trigger, open its detail page in Inboxfm Connect and use the **Test Trigger** panel to run it against a sample payload. It should function as shown in the screenshot.
