...
- [Inboxfm Connect Local development](./development-setup) Or [GitHub Codespaces](../misc/codespaces).
- TypeScript syntax.
...
1. `Piece Name`: Specify a name for your piece. This name uniquely identifies your piece within the Inboxfm Connect ecosystem.
...
? Enter the package name: @inboxfm-connect/piece-gelato
