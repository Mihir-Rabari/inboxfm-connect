...
Inboxfm Connect currently supports the following AI providers:
...
Now we need to tell Inboxfm Connect how to authenticate to your AI provider. You can do this by adding an `auth` property to the `AiProvider` object.
