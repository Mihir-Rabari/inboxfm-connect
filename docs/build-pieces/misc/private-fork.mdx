...
```bash
git clone --bare git@github.com:Mihir-Rabari/inboxfm-connect.git
 ```
...
```bash
git remote add upstream git@github.com:Mihir-Rabari/inboxfm-connect.git
...
upstream	git@github.com:Mihir-Rabari/inboxfm-connect.git (fetch)
