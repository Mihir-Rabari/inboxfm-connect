...
- [ ] Set up your @inboxfm-connect.com email account and setup 2FA
- [ ] Confirm access to our private Discord server.
- [ ] Get Invited to the Inboxfm Connect Github Organization and Setup 2FA
...
Welcome again to the team. We can't wait to see the impact you'll make at Inboxfm Connect! 😉
