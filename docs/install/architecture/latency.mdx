---
title: "Latency"
description: "What Inboxfm Connect adds to a synchronous webhook, warm versus cold, so you can set expectations before building on it"
icon: "stopwatch"
---
...
A warm call is almost entirely per-step bookkeeping, not your code: a progress callback per step, tens of ms each. A step that calls a third-party API waits on that API, often far longer. Next to a real outbound call, the Inboxfm Connect overhead is the smaller number.
