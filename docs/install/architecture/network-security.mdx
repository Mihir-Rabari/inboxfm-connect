...
description: "How Inboxfm Connect isolates outbound traffic from your internal network"
icon: "shield-halved"
---

## Overview

Inboxfm Connect makes outbound HTTP from two surfaces, and each is hardened separately:
