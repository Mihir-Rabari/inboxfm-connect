---
title: "Rollback"
description: "How to rollback Inboxfm Connect to a previous version"
icon: "rotate-left"
---

## Overview

Inboxfm Connect ships a rollback command that reverses database migrations when you need to downgrade to a previous version. Most releases are fully rollback-safe — the release notes will let you know if one isn't.
...
Then switch your `docker-compose.yml` to the previous image version and start Inboxfm Connect.
