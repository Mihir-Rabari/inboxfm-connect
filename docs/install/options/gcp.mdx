...
After a successful deployment, you can access the Inboxfm Connect application by visiting the external IP address of the VM on GCP.

## Production Deployment

Please visit [Inboxfm Connect](/install/reference/environment-variables) for more details on how to customize the application.