---
title: 'Helm'
description: 'Deploy Inboxfm Connect on Kubernetes using Helm'
---

This guide walks you through deploying Inboxfm Connect on Kubernetes using the official Helm chart.
...
Create a `my-values.yaml` file with your configuration. You can use the [example values file](https://github.com/Mihir-Rabari/inboxfm-connect/blob/main/deploy/activepieces-helm/values.yaml) as a reference.
...
Inboxfm Connect supports three editions:
...
- **`cloud`**: For Inboxfm Connect Cloud deployments
...
For Enterprise Edition features and licensing, visit the [Platform Admin overview](/admin-guide/overview).
