...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install Inboxfm Connect"
---

Inboxfm Connect Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.

<Tip>
Community Edition is **free** and **open source**.

You can read the difference between the editions [here](https://www.inboxfm-connect.com/pricing).
</Tip>
...
Deploy Inboxfm Connect as a single Docker container using the PGLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy Inboxfm Connect with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Inboxfm Connect Cloud" icon="cloud" color="##5155D7" href="https://cloud.activepieces.com/">
