...
title: "Limits"
icon: "ban"
description: "Limits enforced on Inboxfm Connect Cloud, with self-hosted overrides"
---
...
<Tip>
For synchronous webhook requests (URLs ending in `/sync`), Inboxfm Connect will
