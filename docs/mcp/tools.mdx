...
icon: "wrench"
description: "Complete catalog of all MCP tools available in Inboxfm Connect"
---
...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `pieceName` | string | Yes | Piece name (e.g., `@inboxfm-connect/piece-slack`) |
...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `pieceName` | string | Yes | Piece name (e.g., `@inboxfm-connect/piece-google-sheets`) |
...
|-------|------|----------|-------------|
| `flowId` | string | Yes | The flow ID |
| `pieceName` | string | Yes | Piece name (e.g., `@inboxfm-connect/piece-gmail`) |
...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `pieceName` | string | Yes | Piece name (e.g. `slack` or `@inboxfm-connect/piece-slack`). Use `ap_research_pieces` to discover. |
