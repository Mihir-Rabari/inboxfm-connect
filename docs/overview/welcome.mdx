...
<CardGroup cols={2}>
  <Card
    ...
    color="#8143E3"
  >
    Learn how to work with Inboxfm Connect
  </Card>
  <Card
    href="https://www.inboxfm-connect.com/integrations"
    title="Pieces"
    icon="puzzle-piece"
    color="#8143E3"
  >
  ...
  <Card
    ...
    color="#8143E3"
  >
    Learn how to install Inboxfm Connect
  </Card>
    <Card
...
- **🤖 AI-Ready**: Native AI pieces and agents are built into Inboxfm Connect. Integrating AI into your flows is seamless and simple—experiment with popular providers, or quickly create custom agents using our easy-to-use AI SDK.
