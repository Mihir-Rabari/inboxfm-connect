import { isNil, SeekPage, PopulatedFlowSummary } from '@inboxfm-connect/pieces-framework';
import { AgentOutputField, AgentOutputFieldType, TASK_COMPLETION_TOOL_NAME, PopulatedFlow, McpTrigger, ExecuteToolResponse, ExecutionToolStatus, McpProperty, McpPropertyType, AgentFlowTool, mcpToolNameUtils, RAW_PAYLOAD_HEADER } from '@inboxfm-connect/pieces-framework';
