import { createTrigger, TriggerStrategy, Property, AppConnectionValueForAuthProperty } from '@inboxfm-connect/pieces-framework';
import { DedupeStrategy, Polling, pollingHelper, httpClient, HttpMethod } from '@inboxfm-connect/pieces-common';
