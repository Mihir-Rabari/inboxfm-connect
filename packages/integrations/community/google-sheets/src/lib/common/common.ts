import { AppConnectionValueForAuthProperty, OAuth2PropertyValue, OAuth2Props, PieceAuth, PiecePropValueSchema, Property, ShortTextProperty, StaticPropsValue } from '@inboxfm-connect/pieces-framework';
import {
	httpClient,
	HttpMethod,
	AuthenticationType,
...
import { isString } from '@inboxfm-connect/pieces-framework';
