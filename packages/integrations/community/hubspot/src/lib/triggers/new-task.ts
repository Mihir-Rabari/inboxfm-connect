import { PiecePropValueSchema, Property, createTrigger } from '@inboxfm-connect/pieces-framework';
import { TriggerStrategy } from '@inboxfm-connect/pieces-framework';
...
import { MarkdownVariant } from '@inboxfm-connect/pieces-framework';
