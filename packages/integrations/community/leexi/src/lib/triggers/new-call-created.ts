import { AppConnectionValueForAuthProperty, createTrigger, TriggerStrategy } from "@inboxfm-connect/pieces-framework";
import { leexiAuth } from "../common/auth";
import { AuthenticationType, DedupeStrategy, httpClient, HttpMethod, Polling, pollingHelper, QueryParams } from "@inboxfm-connect/pieces-common";
import dayjs from 'dayjs';
import { BASE_URL } from "../common/constants";
import { ListCallResponse } from "../common/types";
import { isEmpty } from '@inboxfm-connect/pieces-framework';
