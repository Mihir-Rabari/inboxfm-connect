import { HttpMethod, HttpRequest, httpClient } from '@inboxfm-connect/pieces-common';
import { mauticAuth } from '../auth';
import { Property, TriggerStrategy, createTrigger } from "@inboxfm-connect/pieces-framework";
