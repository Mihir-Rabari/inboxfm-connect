import { HttpMethod, httpClient, HttpRequest } from '@inboxfm-connect/pieces-common';
import { Property, TriggerStrategy } from '@inboxfm-connect/pieces-framework';
import { TriggerHookContext } from '@inboxfm-connect/pieces-framework';
