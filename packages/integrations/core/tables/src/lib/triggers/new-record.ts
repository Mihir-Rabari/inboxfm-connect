import { createTrigger, PieceAuth, TriggerStrategy } from '@inboxfm-connect/pieces-framework';
import { tablesCommon } from '../common';
import { PopulatedRecord, TableWebhookEventType } from '@inboxfm-connect/pieces-framework';
