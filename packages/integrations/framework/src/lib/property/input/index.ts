...
import { MarkdownVariant } from '@inboxfm-connect/core-piece-types';
...
export type InputProperty =
  ...
  | DropdownProperty<any, boolean, IntegrationAuthProperty | undefined | IntegrationAuthProperty[]>
  | StaticDropdownProperty<any, boolean>
  | NumberProperty<boolean>
  | ArrayProperty<boolean>
  | ObjectProperty<boolean>
  | JsonProperty<boolean>
  | MultiSelectDropdownProperty<any, boolean, IntegrationAuthProperty | undefined | IntegrationAuthProperty[]>
  | StaticMultiSelectDropdownProperty<any, boolean>
  | DynamicProperties<boolean, IntegrationAuthProperty | IntegrationAuthProperty[] | undefined>
...
export const Property = {
  ...
  Dropdown<T, R extends boolean = boolean, IntegrationAuth extends IntegrationAuthProperty | IntegrationAuthProperty[] |  undefined = undefined>(
    request: Properties<DropdownProperty<T, R, IntegrationAuth>>
  ): R extends true ? DropdownProperty<T, true, IntegrationAuth> : DropdownProperty<T, false, IntegrationAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DROPDOWN,
    } as unknown as R extends true
      ? DropdownProperty<T, true, IntegrationAuth>
      : DropdownProperty<T, false, IntegrationAuth>;
  },
  ...
  MultiSelectDropdown<T, R extends boolean = boolean, IntegrationAuth extends IntegrationAuthProperty | IntegrationAuthProperty[] | undefined = undefined>(
    request: Properties<MultiSelectDropdownProperty<T, R, IntegrationAuth>>
  ): R extends true
    ? MultiSelectDropdownProperty<T, true, IntegrationAuth>
    : MultiSelectDropdownProperty<T, false, IntegrationAuth> {
    return {
      ...request,
      valueSchema: undefined,
  ...
  DynamicProperties<R extends boolean = boolean, IntegrationAuth extends IntegrationAuthProperty | IntegrationAuthProperty[] | undefined = undefined>(
    request: Properties<DynamicProperties<R,IntegrationAuth>>
  ): R extends true ? DynamicProperties<true, IntegrationAuth> : DynamicProperties<false, IntegrationAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DYNAMIC,
    } as unknown as R extends true
      ? DynamicProperties<true, IntegrationAuth>
      : DynamicProperties<false, IntegrationAuth>;
  },
