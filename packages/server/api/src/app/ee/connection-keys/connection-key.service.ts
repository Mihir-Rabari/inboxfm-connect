...
export const connectionKeyService = (log: FastifyBaseLogger) => ({
    async getConnection({
        ...
        const finalAppName = appName.replace('@inboxfm-connect/piece-', '')
    ...
    async createConnection(
        ...
        // TODO this is hardcoded for now, just to make sure it's not changed on client side
        const finalAppName = `@inboxfm-connect/piece-${appCredential.appName}`
