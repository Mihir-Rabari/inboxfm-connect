import { ApId, ApMultipartFile, isNil } from '@inboxfm-connect/core-utils'
import { AP_MAXIMUM_PROFILE_PICTURE_SIZE, FileType, PrincipalType, PROFILE_PICTURE_ALLOWED_TYPES, SERVICE_KEY_SECURITY_OPENAPI, UpdateMeResponse, UserWithMetaInformation } from '@inboxfm-connect/shared'
