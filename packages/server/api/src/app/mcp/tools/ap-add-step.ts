...
import { BranchExecutionType, FlowActionType, FlowOperationRequest, FlowOperationType, flowStructureUtil, McpToolDefinition, ProjectScopedMcpServer, RouterExecutionType, StepLocationRelativeToParent, UpdateActionRequest } from '@inboxfm-connect/shared'
...
export const apAddStepTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        ...
        inputSchema: {
            ...
            pieceName: z.string().optional().describe('For PIECE steps: the piece name (e.g. "@inboxfm-connect/piece-gmail"). Use ap_research_pieces to get valid values.'),
