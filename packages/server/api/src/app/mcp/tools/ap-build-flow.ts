...
import { FlowActionType, FlowCreatorType, FlowOperationType, flowStructureUtil, FlowTriggerType, McpToolContext, McpToolDefinition, PieceTrigger, StepLocationRelativeToParent, UpdateActionRequest } from '@inboxfm-connect/shared'
...
export const apBuildFlowTool = ({ mcp, userId }: McpToolContext, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        ...
        inputSchema: {
            ...
            trigger: z.object({
                pieceName: z.string().describe('Trigger piece name (e.g. "@inboxfm-connect/piece-webhook")'),
