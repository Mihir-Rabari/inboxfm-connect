...
import { AppConnectionStatus, McpToolDefinition, ProjectScopedMcpServer } from '@inboxfm-connect/shared'
...
const listConnectionsSchema = z.object({
    pieceName: z
        ...
        .optional()
        .describe(
            'Filter by piece name. Short names like "slack" or "google-drive" are auto-expanded to full format (e.g. "@inboxfm-connect/piece-slack"). You can also pass the full name directly.',
        ),
    displayName: z
        .string()
        .optional()
