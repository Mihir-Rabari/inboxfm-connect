...
const setupGuideInput = z.object({
    ...
    pieceName: z.string().optional().describe('For connections: the piece that needs auth (e.g., "@inboxfm-connect/piece-gmail"). Omit for general instructions.'),
})
        ...
        return {
            content: [{
                ...
                text: [
                    ...
                    '',
                    'Tip: Pass pieceName to this tool for specific instructions (e.g., pieceName: "@inboxfm-connect/piece-gmail").',
                ].join('\n'),
            }],
        }
    }
