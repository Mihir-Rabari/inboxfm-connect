...
import { FlowOperationRequest, FlowOperationType, FlowTriggerType, McpToolDefinition, PieceTrigger, ProjectScopedMcpServer } from '@inboxfm-connect/shared'
...
export const apUpdateTriggerTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        ...
        inputSchema: {
            ...
            pieceName: z.string().describe('The piece name for the trigger (e.g. "@inboxfm-connect/piece-gmail"). Use ap_research_pieces to get valid values.'),
