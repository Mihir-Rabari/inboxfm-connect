...
import { FlowAction, FlowActionType, FlowOperationStatus, FlowStatus, FlowTrigger, FlowTriggerType, FlowVersion, FlowVersionState, PopulatedFlow, PropertyExecutionType } from '@inboxfm-connect/shared'
...
function generateAction(): FlowAction {
    return {
        ...
        settings: {
            input: {},
            pieceName: faker.helpers.arrayElement(['@inboxfm-connect/piece-schedule', '@inboxfm-connect/piece-webhook']),
