...
import { AppConnection, AppConnectionScope, AppConnectionStatus, AppConnectionType, CustomAuthConnectionValue, PackageType, PieceType } from '@inboxfm-connect/shared'
