...
async function setupSubflowFixtures() {
    ...
    const webhookPiece = createMockPieceMetadata({
        name: '@inboxfm-connect/piece-webhook',
        version: '0.1.29',
    ...
    const subflowsPiece = createMockPieceMetadata({
        name: '@inboxfm-connect/piece-subflows',
        version: '0.4.11',
        platformId: undefined,
        packageType: PackageType.REGISTRY,
        pieceType: PieceType.OFFICIAL,
    ...
    const childReturnResponseAction = {
        ...
        valid: true,
        settings: {
            pieceName: '@inboxfm-connect/piece-subflows',
            pieceVersion: '0.4.11',
...
describe('Execute Flow E2E', () => {
    it('executes a webhook → data mapper → code flow end-to-end', async () => {
        ...
        const dataMapperPiece = createMockPieceMetadata({
            name: '@inboxfm-connect/piece-data-mapper',
            version: '0.3.15',
            platformId: undefined,
            packageType: PackageType.REGISTRY,
            pieceType: PieceType.OFFICIAL,
        ...
        const dataMapperAction = {
            ...
            valid: true,
            settings: {
                pieceName: '@inboxfm-connect/piece-data-mapper',
                pieceVersion: '0.3.15',
    ...
    it('executes a webhook → delay_for → code flow without infinite loop', async () => {
        ...
        const delayPiece = createMockPieceMetadata({
            name: '@inboxfm-connect/piece-delay',
            version: '0.3.26',
            platformId: undefined,
            packageType: PackageType.REGISTRY,
            pieceType: PieceType.OFFICIAL,
        ...
        const delayAction = {
            ...
            valid: true,
            settings: {
                pieceName: '@inboxfm-connect/piece-delay',
                pieceVersion: '0.3.26',
                actionName: 'delayFor',
                input: {
                    unit: 'seconds',
