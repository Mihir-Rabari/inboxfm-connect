...
import { FlowStatus, FlowTriggerType, FlowVersionState, PackageType, PieceType } from '@inboxfm-connect/shared'
    ...
    describe('GET /v1/human-input/form/:flowId', () => {
        it('should return form config for flow with form trigger', async () => {
            ...
            const mockPiece = createMockPieceMetadata({
                name: '@inboxfm-connect/piece-forms',
                version: '0.2.0',
            ...
            const mockFlowVersion = createMockFlowVersion({
                ...
                trigger: {
                    ...
                    settings: {
                        pieceName: '@inboxfm-connect/piece-forms',
                        pieceVersion: '0.2.0',
