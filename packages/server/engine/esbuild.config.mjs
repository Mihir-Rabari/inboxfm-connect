...
function buildOptions({ outfile }) {
  return {
    ...
    treeShaking: true,
    alias: {
        '@inboxfm-connect/shared': path.resolve(__dirname, '../../core/shared/src'),
        '@inboxfm-connect/pieces-framework': path.resolve(__dirname, '../../integrations/framework/src'),
        '@inboxfm-connect/pieces-common': path.resolve(__dirname, '../../integrations/common/src'),
        '@inboxfm-connect/core-utils': path.resolve(__dirname, '../../core/utils/src'),
        '@inboxfm-connect/core-piece-types': path.resolve(__dirname, '../../core/piece-types/src'),
        '@inboxfm-connect/core-formula': path.resolve(__dirname, '../../core/formula/src'),
        '@inboxfm-connect/core-execution': path.resolve(__dirname, '../../core/execution/src'),
    },
